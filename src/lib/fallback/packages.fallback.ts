    ...
    media: [
      {
        ...
        is_featured: true,
        image_url:
          "https://images.unsplash.com/photo-1544644181-1484b3fdfc62?q=80&w=1080&auto=format&fit=crop",
      },
    ],
    inclusions: [
    ...
    media: [
      {
        ...
        is_featured: true,
        image_url:
          "https://images.unsplash.com/photo-1531366936310-6cb1c83a149a?q=80&w=1080&auto=format&fit=crop",
      },
    ],
    inclusions: [
      { description: "Flight", is_included: true },
    ...
    itineraries: [
      {
        day_number: 1,
        title: "Arrival",
        description: "Arrive in Swiss Alps",
        location: "Zurich",
      },
      {
        day_number: 2,
