...
/**
 * stat-counter.tsx
 * Pure animated counter card — spring-based counting animation.
 * Animation hooks (useInView/useSpring) are tightly coupled to this UI unit.
 */
...
import type { IconKey } from './about-us.constants'
