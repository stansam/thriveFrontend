...
import { SERVICES, STATS } from "../../_constants/landing/about-us-data.constants";
...
import type { AboutUsSectionProps } from "../../_props/landing/about.props";
    ...
    >
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <p className="text-center max-w-3xl mx-auto mb-16 text-[#202e44]/80 leading-relaxed">
          Thrive Global Travel &amp; Tours is a premium travel service company
          specializing in domestic and international flight bookings, group
          travel arrangements, and corporate travel management. We streamline
          travel by providing fast quotations, affordable service fees, and
