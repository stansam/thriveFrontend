...
import { FeaturedPackageInclusions } from './package-inclusions'
import type { FeaturedPackageCardProps } from '../../../_props/landing/featured.props'
            ...
            <div className="flex flex-1 flex-col justify-between p-6">
                <div>
                    ...
                    <div className="space-y-4 text-sm">
                        <FeaturedPackageInclusions inclusions={item.inclusions} />
                    </div>
                </div>
