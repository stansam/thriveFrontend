      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-white/60 text-center max-w-md">
            Your premium partner for stress-free travel, flight bookings, and
            corporate solutions.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 mt-12 pt-8 border-t border-white/5 text-xs text-white/40">
          <span>
            &copy; <ClientYear /> Thrive Global Travel &amp; Tours.
            All rights reserved.
          </span>
